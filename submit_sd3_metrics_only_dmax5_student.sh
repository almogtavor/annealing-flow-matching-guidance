#!/bin/bash
#SBATCH --job-name=sd3-metrics-dmax5-stu
#SBATCH --nodes=1
...
#SBATCH --output=logs/metrics/slurm_metrics_dmax5_stu_%j.log
#SBATCH --error=logs/metrics/slurm_metrics_dmax5_stu_%j.log
